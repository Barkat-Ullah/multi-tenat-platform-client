...
} from "@/redux/service/admin/notificationsApi";
...
const getNotificationTitle = (notification: AdminNotification) =>
  notification.title ||
...
const getNotificationLocation = (notification: AdminNotification) =>
...
const getNotificationTime = (notification: AdminNotification) => {
...
const isNotificationRead = (notification: AdminNotification) =>
