...
import type { AirsideMedicalData } from "@/app/data/OccupationalHealthData";

interface AirsideMedicalSectionProps {
  data: AirsideMedicalData;
}

export default function AirsideMedicalSection({ data }: AirsideMedicalSectionProps) {
  return (
