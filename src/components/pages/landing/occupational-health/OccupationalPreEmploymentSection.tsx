...
import type { OccupationalPreEmploymentData } from "@/app/data/OccupationalHealthData";

interface OccupationalPreEmploymentSectionProps {
  data: OccupationalPreEmploymentData;
}

export default function OccupationalPreEmploymentSection({ data }: OccupationalPreEmploymentSectionProps) {
  return (
