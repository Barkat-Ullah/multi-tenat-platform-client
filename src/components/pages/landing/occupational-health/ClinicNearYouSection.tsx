...
import type { ClinicNearYouData } from "@/app/data/OccupationalHealthData";

interface ClinicNearYouSectionProps {
  data: ClinicNearYouData;
}

export default function ClinicNearYouSection({ data }: ClinicNearYouSectionProps) {
  return (
