...
import type { SeafarersMedicalData } from "@/app/data/OccupationalHealthData";

interface SeafarersMedicalSectionProps {
  data: SeafarersMedicalData;
}

export default function SeafarersMedicalSection({ data }: SeafarersMedicalSectionProps) {
  return (
