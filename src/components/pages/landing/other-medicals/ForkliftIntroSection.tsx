...
import type { ForkliftIntroData } from "@/app/data/OtherMedicalData";

interface ForkliftIntroSectionProps {
  data: ForkliftIntroData;
}

export default function ForkliftIntroSection({ data }: ForkliftIntroSectionProps) {
  return (
