...
import type { CraneIntroData } from "@/app/data/OtherMedicalData";

interface CraneIntroSectionProps {
  data: CraneIntroData;
}

export default function CraneIntroSection({ data }: CraneIntroSectionProps) {
  return (
