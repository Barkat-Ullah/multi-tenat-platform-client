...
import type { MotorsportIntroData } from "@/app/data/OtherMedicalData";

interface MotorsportIntroSectionProps {
  data: MotorsportIntroData;
}

export default function MotorsportIntroSection({ data }: MotorsportIntroSectionProps) {
  return (
