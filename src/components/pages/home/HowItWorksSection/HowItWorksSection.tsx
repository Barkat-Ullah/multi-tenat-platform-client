      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-6 md:gap-8">
              {howItWorksStepsData.map((step, index) => {
                ...
                return (
                  <div
                    key={step.number}
                    className={`flex items-start sm:items-center gap-3 sm:gap-4 md:gap-8 ${isEven ? "sm:justify-end text-left" : "sm:justify-start text-left"
                      }`}
                  >
          ...
          <div className="lg:col-span-5 flex justify-center items-center">
            <div className="relative w-full max-w-[420px] sm:max-w-[500px] lg:max-w-none lg:min-w-[420px] aspect-[4/5] hover:scale-[1.01] transition-all duration-500">
              <Image
                src={howItWorksHero}
