...
export default function TestimonialsSection() {
  ...
  return (
    <section className="py-20 md:py-28 bg-white poppins overflow-hidden">
      <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-6 flex">
            <div className="w-full bg-[#1A2530] text-white rounded-[2.5rem] p-8 md:p-12 lg:p-16 flex flex-col justify-between items-center text-center shadow-[0_15px_45px_rgba(0,0,0,0.08)] relative overflow-hidden min-h-[380px] sm:min-h-[420px] md:min-h-[460px]">
              ...
              <div className="flex-1 flex flex-col justify-center items-center w-full relative">
                <AnimatePresence initial={false} custom={direction} mode="wait">
                  ...
                  >
                    {/* User Meta (Centered) */}
                    <div className="flex items-center gap-1.5 text-slate-300 font-semibold text-xs sm:text-sm tracking-wide mb-6 uppercase">
                    ...
                    {/* Review Content */}
                    <blockquote className="text-lg sm:text-xl md:text-2xl font-medium leading-relaxed tracking-tight text-white/95 max-w-[480px]">
          ...
          <div className="lg:col-span-6 flex">
            <motion.div
              ...
              className="relative w-full aspect-[4/3] lg:aspect-auto rounded-[2.5rem] overflow-hidden shadow-lg border border-slate-100 hover:shadow-xl transition-shadow duration-500 min-h-[300px]"
            >
              <Image
                src={testimonialHero}
