    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto w-full px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-24 relative z-10">
        <div className="flex flex-col items-start text-left">
          ...
          <div className="inline-flex items-center gap-2 rounded-full mb-6 border border-[#00B2D6]/20 bg-white/95 px-4 py-1.5 text-xs font-semibold text-[#0F2E4A] shadow-sm backdrop-blur-md">
