...
const navItems = [
...

  {
    ...
    label: (
      <Link href="/dashboard/super-admin/schedule-slots">Schedule Slots</Link>
    ),
...

  {
    ...
    label: (
      <Link href="/dashboard/super-admin/support-center">Support Center</Link>
    ),
  ...
  },
  {
    ...
    label: (
      <Link href="/dashboard/super-admin/payment-settings">
        Payment Settings
      </Link>
    ),
  ...
  },
  {
    ...
    label: (
      <Link href="/dashboard/super-admin/privacy-policy">Privacy Policy</Link>
    ),
  ...
  },
  {
    ...
    label: (
      <Link href="/dashboard/super-admin/terms-of-service">
        Terms of Service
      </Link>
    ),
